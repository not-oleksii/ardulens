...
const FAKE_PARAM_SEED: ReadonlyArray<readonly [string, number, MavParamType]> = [
  ...
  // OSD Setup tab - real param names confirmed against ArduCopter's own apm.pdef.xml (see
  // osdSetupParams.ts). Only screen 1 gets a hand-picked subset of elements enabled, with the
  // rest of that screen's ~60 other elements and all of screens 2-4's elements left unseeded
  // (never answered, same as a param a given firmware build doesn't expose) - same "small,
  // hand-picked set" convention as the rest of this seed list, not exhaustive coverage.
  ["OSD_TYPE", 1, MavParamType.INT8],
  ["OSD_UNITS", 0, MavParamType.INT8],
  ["OSD_CHAN", 0, MavParamType.INT8],
  ["OSD1_ENABLE", 1, MavParamType.INT8],
  ["OSD1_CHAN_MIN", 0, MavParamType.INT16],
  ["OSD1_CHAN_MAX", 0, MavParamType.INT16],
  ["OSD2_ENABLE", 0, MavParamType.INT8],
  ["OSD2_CHAN_MIN", 0, MavParamType.INT16],
  ["OSD2_CHAN_MAX", 0, MavParamType.INT16],
  ["OSD1_ALTITUDE_EN", 1, MavParamType.INT8],
  ["OSD1_ALTITUDE_X", 23, MavParamType.INT8],
  ["OSD1_ALTITUDE_Y", 8, MavParamType.INT8],
  ["OSD1_BAT_VOLT_EN", 1, MavParamType.INT8],
  ["OSD1_BAT_VOLT_X", 2, MavParamType.INT8],
  ["OSD1_BAT_VOLT_Y", 1, MavParamType.INT8],
  ["OSD1_RSSI_EN", 1, MavParamType.INT8],
  ["OSD1_RSSI_X", 2, MavParamType.INT8],
  ["OSD1_RSSI_Y", 14, MavParamType.INT8],
  ["OSD1_CURRENT_EN", 1, MavParamType.INT8],
  ["OSD1_CURRENT_X", 2, MavParamType.INT8],
  ["OSD1_CURRENT_Y", 2, MavParamType.INT8],
  ["OSD1_SATS_EN", 1, MavParamType.INT8],
  ["OSD1_SATS_X", 2, MavParamType.INT8],
  ["OSD1_SATS_Y", 3, MavParamType.INT8],
  ["OSD1_FLTMODE_EN", 1, MavParamType.INT8],
  ["OSD1_FLTMODE_X", 23, MavParamType.INT8],
  ["OSD1_FLTMODE_Y", 0, MavParamType.INT8],
  ["OSD1_HORIZON_EN", 1, MavParamType.INT8],
  ["OSD1_HORIZON_X", 15, MavParamType.INT8],
  ["OSD1_HORIZON_Y", 8, MavParamType.INT8],
  ["OSD1_HOME_EN", 1, MavParamType.INT8],
  ["OSD1_HOME_X", 23, MavParamType.INT8],
  ["OSD1_HOME_Y", 14, MavParamType.INT8],
  ["OSD1_THROTTLE_EN", 1, MavParamType.INT8],
  ["OSD1_THROTTLE_X", 2, MavParamType.INT8],
  ["OSD1_THROTTLE_Y", 5, MavParamType.INT8],
